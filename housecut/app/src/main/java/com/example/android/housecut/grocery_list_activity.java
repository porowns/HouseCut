    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.settings_icon:
                Intent intent = new Intent(grocery_list_activity.this, settings_activity.class);
                startActivity(intent);
                return true;

            case R.id.grocery_list_icon:
                Intent intent2 = new Intent(grocery_list_activity.this, grocery_list_activity.class);
                startActivity(intent2);
                return true;

            case R.id.task_list_icon:
                Intent intent3 = new Intent(grocery_list_activity.this, task_list_activity.class);
                startActivity(intent3);
                return true;

            case R.id.home_page_icon:
                Intent intent4 = new Intent(grocery_list_activity.this, main_page_activity.class);
